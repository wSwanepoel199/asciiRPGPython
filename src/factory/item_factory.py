...
healing_potion = Item(
    ...
    consumable=consumable.HealingConsumable(
        amount=[4, 10], on_use="You drink the Healing Potion! Healing <amount> of HP!"),
)
...
cure_wounds_scroll = Item(
    ...
    consumable=consumable.HealingConsumable(
        amount=[7, 21],  on_use="You cast Cure Wounds! Healing <amount> of HP!"),
)
...
lightning_bolt_scroll = Item(
    ...
    consumable=consumable.LightningBoltConsumable(
        damage=[10, 20], range=7, on_hit_message="A lightning bolt strikes out at the <target> dealing <damage> damage!")
)
